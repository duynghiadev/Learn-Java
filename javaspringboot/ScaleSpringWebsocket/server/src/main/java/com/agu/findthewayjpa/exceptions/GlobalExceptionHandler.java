...
import com.agu.findthewayjpa.errors.ApiException;
import com.agu.findthewayjpa.errors.ApiResponse;
import com.agu.findthewayjpa.errors.ApiValidationErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Object> handleValidationException(MethodArgumentNotValidException ex) {
        ...
        return new ResponseEntity<>(new ApiValidationErrorResponse(errors, null), HttpStatus.BAD_REQUEST);
    }
